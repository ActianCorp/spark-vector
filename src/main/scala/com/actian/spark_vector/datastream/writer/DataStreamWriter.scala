 ...
 */
class DataStreamWriter[T <% Seq[Any]](writeConf: VectorEndpointConf, tableMetadataSchema: Seq[ColumnMetadata])
...
object DataStreamWriter extends Logging {
  ...
  def writeNullTerminatedString(out: DataOutputStream, s: String): Unit = {
