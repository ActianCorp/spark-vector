...
object VectorSRP {
  ...
  final val vectorN: BigInt = BigInt("""
  ...
  final val vectorG: BigInt = BigInt("13", 16)
  final val authCode = Array(4, 1, 0) /* srp */
  final val sBCode = Array(4, 1, 1)
  final val MCode = Array(4, 1, 2)
