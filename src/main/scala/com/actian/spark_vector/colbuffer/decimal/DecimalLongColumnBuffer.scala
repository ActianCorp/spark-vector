...
private class DecimalLongColumnBuffer(valueCount: Int, name: String, precision: Int, scale: Int, nullable: Boolean) extends
  DecimalColumnBuffer(valueCount, LongSize, name, precision, scale, nullable) {
