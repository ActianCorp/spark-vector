 ...
 *  \$SPARK_VECTOR/loader/target/spark_vector_loader-assembly-1.0-SNAPSHOT.jar load csv -sf "hdfs://namenode:8020/data/csv_file*"
 ...
 * {{{
 * spark-submit --master spark://spark_master:7077 --class com.actian.spark_vector.loader.Main
 *  \$SPARK_VECTOR/loader/target/spark_vector_loader-assembly-1.0-SNAPSHOT.jar load parquet -sf "hdfs://namenode:8020/data/parquet_file.parquet"
