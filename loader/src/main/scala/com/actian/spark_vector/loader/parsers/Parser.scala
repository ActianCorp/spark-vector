...
object Args {
  ...
  val preSQL :ArgOption[Seq[String], Option[Seq[String]]] = ArgOption[Seq[String], Option[Seq[String]]](
  ...
  val postSQL :ArgOption[Seq[String], Option[Seq[String]]] = ArgOption[Seq[String], Option[Seq[String]]](
  ...
  val createTable :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val inferSchema :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val ignoreTrailing :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val negativeInf :ArgOption[String, Option[String]] = ArgOption[String, Option[String]](
  ...
  val dateFormat :ArgOption[String, Option[String]] = ArgOption[String, Option[String]](
    "dateFormat", "df", "CSV date format string", _.csv.dateFormat, updateCSV((o, v) => o.copy(dateFormat = Option(v))), false)
  val timestampFormat :ArgOption[String, Option[String]] = ArgOption[String, Option[String]](
    "timestampFormat", "tf", "CSV timestamp format string", _.csv.timestampFormat, updateCSV((o, v) => o.copy(timestampFormat = Option(v))), false)
  val parseMode :ArgOption[String, Option[String]] = ArgOption[String, Option[String]](
  ...
  val header :ArgOption[String, Option[Seq[_]]] = ArgOption[String, Option[Seq[_]]](
  ...
  val allowComments :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val allowUnquoted :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val allowSingleQuotes :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val allowLeadingZeros :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val allowEscapingAny :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
  ...
  val multiline :ArgOption[Boolean, Option[Boolean]] = ArgOption[Boolean, Option[Boolean]](
